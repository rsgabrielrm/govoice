                    ...
                    <div class="h-screen">
                            ...
                            <div class="w-1/2 xl:w-2/4 px-3">
                                <div class="w-full bg-white border text-blue-700 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                                    ...
                                    <div class="text-gray-700">
                                        <p class="font-semibold text-3xl">{{ $customer->name }}</p>
                        ...
                        <div class="text-right">
                            <a
                                ...
                                href="{{ route('number.preferences.create', $number->id) }}"
                            >
                                    New preference number
                            </a>
                        </div>
                        ...
                        <div class="pt-6 text-center">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                @forelse($numberPreferences as $numberPreference)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ $numberPreference->name }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ $numberPreference->value }}
                                            </div>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                              {{ $numberPreference->auto_attendant ? 'Enabled' : 'Disabled' }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{ $numberPreference->voicemail_enabled ? 'Enabled' : 'Disabled' }}
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">

                                            <a href="{{ route('number.preferences.edit', [$numberPreference->number_id, $numberPreference->id]) }}"
                                            ...
                                            <a onclick="openModal('deleteConfirme', '{{ $numberPreference->name }}', '{{ route('number.preferences.destroy',[$numberPreference->number_id, $numberPreference->id]) }}')"
